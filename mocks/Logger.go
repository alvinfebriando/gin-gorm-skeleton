...
import (
	...
	applogger "github.com/alvinfebriando/gin-gorm-skeleton/applogger"
...
func (_m *Logger) GetWriter() io.Writer {
	ret := _m.Called()
...
func (_m *Logger) WithFields(args map[string]interface{}) applogger.Logger {
	ret := _m.Called(args)

	var r0 applogger.Logger
	if rf, ok := ret.Get(0).(func(map[string]interface{}) applogger.Logger); ok {
		r0 = rf(args)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(applogger.Logger)
		}
	}
